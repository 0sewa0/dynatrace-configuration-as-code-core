...
openapi-generator generate -i tenant_specs/environment_api.json -g go -t template -o environment --remove-operation-id-prefix --enable-post-process-file --additional-properties=packageName=environment
