...
// GetUnlicensedOk returns a tuple with the Unlicensed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostAgentInfo) GetUnlicensedOk() (*bool, bool) {
	if o == nil || IsNil(o.Unlicensed) {
		return nil, false
	}
	return o.Unlicensed, true
}
...
func (o HostAgentInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Unlicensed) {
		toSerialize["unlicensed"] = o.Unlicensed
	}
