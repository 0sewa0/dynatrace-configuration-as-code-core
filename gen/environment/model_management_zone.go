...
type _ManagementZone ManagementZone
...
func (o *ManagementZone) UnmarshalJSON(bytes []byte) (err error) {
	...
	varManagementZone := _ManagementZone{}

	err = json.Unmarshal(bytes, &varManagementZone)

	if err != nil {
		return err
	}

	*o = ManagementZone(varManagementZone)
