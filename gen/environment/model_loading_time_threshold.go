...
type _LoadingTimeThreshold LoadingTimeThreshold
...
func (o *LoadingTimeThreshold) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLoadingTimeThreshold := _LoadingTimeThreshold{}

	err = json.Unmarshal(bytes, &varLoadingTimeThreshold)

	if err != nil {
		return err
	}

	*o = LoadingTimeThreshold(varLoadingTimeThreshold)
