...
func (o *RequestDto) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRequestDto := _RequestDto{}

	err = json.Unmarshal(bytes, &varRequestDto)

	if err != nil {
		return err
	}

	*o = RequestDto(varRequestDto)
