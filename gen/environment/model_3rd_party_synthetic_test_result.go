...
type _Model3rdPartySyntheticTestResult Model3rdPartySyntheticTestResult
...
func (o *Model3rdPartySyntheticTestResult) UnmarshalJSON(bytes []byte) (err error) {
	...
	varModel3rdPartySyntheticTestResult := _Model3rdPartySyntheticTestResult{}

	err = json.Unmarshal(bytes, &varModel3rdPartySyntheticTestResult)

	if err != nil {
		return err
	}

	*o = Model3rdPartySyntheticTestResult(varModel3rdPartySyntheticTestResult)
