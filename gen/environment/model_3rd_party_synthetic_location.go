...
type _Model3rdPartySyntheticLocation Model3rdPartySyntheticLocation
...
func (o *Model3rdPartySyntheticLocation) UnmarshalJSON(bytes []byte) (err error) {
	...
	varModel3rdPartySyntheticLocation := _Model3rdPartySyntheticLocation{}

	err = json.Unmarshal(bytes, &varModel3rdPartySyntheticLocation)

	if err != nil {
		return err
	}

	*o = Model3rdPartySyntheticLocation(varModel3rdPartySyntheticLocation)
