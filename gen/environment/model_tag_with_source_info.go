...
type _TagWithSourceInfo TagWithSourceInfo
...
func (o *TagWithSourceInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTagWithSourceInfo := _TagWithSourceInfo{}

	err = json.Unmarshal(bytes, &varTagWithSourceInfo)

	if err != nil {
		return err
	}

	*o = TagWithSourceInfo(varTagWithSourceInfo)
