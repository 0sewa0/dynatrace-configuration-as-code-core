...
type _MaintenanceWindowSchedule MaintenanceWindowSchedule
...
func (o *MaintenanceWindowSchedule) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMaintenanceWindowSchedule := _MaintenanceWindowSchedule{}

	err = json.Unmarshal(bytes, &varMaintenanceWindowSchedule)

	if err != nil {
		return err
	}

	*o = MaintenanceWindowSchedule(varMaintenanceWindowSchedule)
