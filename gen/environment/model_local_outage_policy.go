...
type _LocalOutagePolicy LocalOutagePolicy
...
func (o *LocalOutagePolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLocalOutagePolicy := _LocalOutagePolicy{}

	err = json.Unmarshal(bytes, &varLocalOutagePolicy)

	if err != nil {
		return err
	}

	*o = LocalOutagePolicy(varLocalOutagePolicy)
