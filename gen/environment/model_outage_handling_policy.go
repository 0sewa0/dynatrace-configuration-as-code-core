...
type _OutageHandlingPolicy OutageHandlingPolicy
...
func (o *OutageHandlingPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOutageHandlingPolicy := _OutageHandlingPolicy{}

	err = json.Unmarshal(bytes, &varOutageHandlingPolicy)

	if err != nil {
		return err
	}

	*o = OutageHandlingPolicy(varOutageHandlingPolicy)
