...
func (o *Monitors) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMonitors := _Monitors{}

	err = json.Unmarshal(bytes, &varMonitors)

	if err != nil {
		return err
	}

	*o = Monitors(varMonitors)
