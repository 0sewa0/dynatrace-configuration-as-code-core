...
func (o *EntityIdDto) UnmarshalJSON(bytes []byte) (err error) {
	...
	varEntityIdDto := _EntityIdDto{}

	err = json.Unmarshal(bytes, &varEntityIdDto)

	if err != nil {
		return err
	}

	*o = EntityIdDto(varEntityIdDto)
