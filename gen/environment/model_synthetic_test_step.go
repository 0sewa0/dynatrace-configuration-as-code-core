...
type _SyntheticTestStep SyntheticTestStep
...
func (o *SyntheticTestStep) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSyntheticTestStep := _SyntheticTestStep{}

	err = json.Unmarshal(bytes, &varSyntheticTestStep)

	if err != nil {
		return err
	}

	*o = SyntheticTestStep(varSyntheticTestStep)
