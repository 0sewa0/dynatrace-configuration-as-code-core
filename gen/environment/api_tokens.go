...
func (a *TokensAPIService) CreateTokenExecute(r ApiCreateTokenRequest) (*Token, *http.Response, error) {
	...
	localVarHTTPHeaderAccepts := []string{"application/json; charset=utf-8", "text/csv; header=absent; charset=utf-8", "text/csv; header=present; charset=utf-8", "text/plain; charset=utf-8", "application/json"}
