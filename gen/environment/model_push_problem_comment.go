...
type _PushProblemComment PushProblemComment
...
func (o *PushProblemComment) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPushProblemComment := _PushProblemComment{}

	err = json.Unmarshal(bytes, &varPushProblemComment)

	if err != nil {
		return err
	}

	*o = PushProblemComment(varPushProblemComment)
