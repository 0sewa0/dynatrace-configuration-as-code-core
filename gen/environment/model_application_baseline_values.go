...
type _ApplicationBaselineValues ApplicationBaselineValues
...
func (o *ApplicationBaselineValues) UnmarshalJSON(bytes []byte) (err error) {
	...
	varApplicationBaselineValues := _ApplicationBaselineValues{}

	err = json.Unmarshal(bytes, &varApplicationBaselineValues)

	if err != nil {
		return err
	}

	*o = ApplicationBaselineValues(varApplicationBaselineValues)
