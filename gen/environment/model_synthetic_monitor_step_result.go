...
type _SyntheticMonitorStepResult SyntheticMonitorStepResult
...
func (o *SyntheticMonitorStepResult) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSyntheticMonitorStepResult := _SyntheticMonitorStepResult{}

	err = json.Unmarshal(bytes, &varSyntheticMonitorStepResult)

	if err != nil {
		return err
	}

	*o = SyntheticMonitorStepResult(varSyntheticMonitorStepResult)
