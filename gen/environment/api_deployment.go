...
func (r ApiGetActiveGateInstallerConnectionInfoRequest) DefaultZoneFallback(defaultZoneFallback bool) ApiGetActiveGateInstallerConnectionInfoRequest {
...
func (a *DeploymentAPIService) GetActiveGateInstallerConnectionInfoExecute(r ApiGetActiveGateInstallerConnectionInfoRequest) (*ActiveGateConnectionInfo, *http.Response, error) {
	...
	if r.defaultZoneFallback != nil {
		...
		var defaultValue bool = false
		r.defaultZoneFallback = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetAgentInstallerMetaInfoRequest) Execute() (*AgentInstallerMetaInfoDto, *http.Response, error) {
...
//
//	@return AgentInstallerMetaInfoDto
func (a *DeploymentAPIService) GetAgentInstallerMetaInfoExecute(r ApiGetAgentInstallerMetaInfoRequest) (*AgentInstallerMetaInfoDto, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AgentInstallerMetaInfoDto
	)
...
func (r ApiGetAgentProcessModuleConfigRequest) Sections(sections string) ApiGetAgentProcessModuleConfigRequest {
	r.sections = &sections
	return r
}

// The name of the host group the process is part of.
func (r ApiGetAgentProcessModuleConfigRequest) Hostgroup(hostgroup string) ApiGetAgentProcessModuleConfigRequest {
...
func (a *DeploymentAPIService) GetAgentProcessModuleConfigExecute(r ApiGetAgentProcessModuleConfigRequest) (*AgentProcessModuleConfigResponse, *http.Response, error) {
	...
	if r.sections != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sections", r.sections, "")
	} else {
		var defaultValue string = "general"
		r.sections = &defaultValue
	}
	if r.hostgroup != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hostgroup", r.hostgroup, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
// The architecture of your OS:   * &#x60;all&#x60;: Defaults to &#x60;amd64&#x60;.  * &#x60;amd64&#x60;: amd64 architecture. * &#x60;s390&#x60;: S/390 architecture, only supported for Linux.
func (r ApiGetGatewayInstallerMetaInfoRequest) Arch(arch string) ApiGetGatewayInstallerMetaInfoRequest {
	r.arch = &arch
	return r
}

func (r ApiGetGatewayInstallerMetaInfoRequest) Execute() (*GatewayInstallerMetaInfoDto, *http.Response, error) {
	return r.ApiService.GetGatewayInstallerMetaInfoExecute(r)
}
...
//
//	@return GatewayInstallerMetaInfoDto
func (a *DeploymentAPIService) GetGatewayInstallerMetaInfoExecute(r ApiGetGatewayInstallerMetaInfoRequest) (*GatewayInstallerMetaInfoDto, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GatewayInstallerMetaInfoDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.GetGatewayInstallerMetaInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/installer/gateway/{osType}/latest/metainfo"
	localVarPath = strings.Replace(localVarPath, "{"+"osType"+"}", url.PathEscape(parameterValueToString(r.osType, "osType")), -1)
...
func (r ApiGetLatestActiveGateImageRequest) Execute() (*ImageDto, *http.Response, error) {
	return r.ApiService.GetLatestActiveGateImageExecute(r)
}
...
Returns the latest available ActiveGate image
	...
	@return ApiGetLatestActiveGateImageRequest
*/
func (a *DeploymentAPIService) GetLatestActiveGateImage(ctx context.Context) ApiGetLatestActiveGateImageRequest {
	return ApiGetLatestActiveGateImageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DeploymentAPIService) GetLatestActiveGateImageExecute(r ApiGetLatestActiveGateImageRequest) (*ImageDto, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.GetLatestActiveGateImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/image/gateway/latest"
...
func (r ApiGetLatestAgentImageRequest) Execute() (*ImageDto, *http.Response, error) {
	return r.ApiService.GetLatestAgentImageExecute(r)
}
...
func (a *DeploymentAPIService) GetLatestAgentImageExecute(r ApiGetLatestAgentImageRequest) (*ImageDto, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.GetLatestAgentImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/image/agent/{agentImageType}/latest"
	localVarPath = strings.Replace(localVarPath, "{"+"agentImageType"+"}", url.PathEscape(parameterValueToString(r.agentImageType, "agentImageType")), -1)
...
func (r ApiGetLatestSyntheticImageRequest) Execute() (*ImageDto, *http.Response, error) {
	return r.ApiService.GetLatestSyntheticImageExecute(r)
}
...
func (a *DeploymentAPIService) GetLatestSyntheticImageExecute(r ApiGetLatestSyntheticImageRequest) (*ImageDto, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeploymentAPIService.GetLatestSyntheticImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deployment/image/synthetic/{imageKey}/latest"
	localVarPath = strings.Replace(localVarPath, "{"+"imageKey"+"}", url.PathEscape(parameterValueToString(r.imageKey, "imageKey")), -1)
