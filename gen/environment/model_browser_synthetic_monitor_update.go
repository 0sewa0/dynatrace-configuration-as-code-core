...
type _BrowserSyntheticMonitorUpdate BrowserSyntheticMonitorUpdate
...
func (o BrowserSyntheticMonitorUpdate) ToMap() (map[string]interface{}, error) {
	...
	if errSyntheticMonitorUpdate != nil {
		return map[string]interface{}{}, errSyntheticMonitorUpdate
	}
...
func (o *BrowserSyntheticMonitorUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBrowserSyntheticMonitorUpdate := _BrowserSyntheticMonitorUpdate{}

	err = json.Unmarshal(bytes, &varBrowserSyntheticMonitorUpdate)

	if err != nil {
		return err
	}

	*o = BrowserSyntheticMonitorUpdate(varBrowserSyntheticMonitorUpdate)
