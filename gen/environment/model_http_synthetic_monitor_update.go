...
type _HttpSyntheticMonitorUpdate HttpSyntheticMonitorUpdate
...
func (o *HttpSyntheticMonitorUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varHttpSyntheticMonitorUpdate := _HttpSyntheticMonitorUpdate{}

	err = json.Unmarshal(bytes, &varHttpSyntheticMonitorUpdate)

	if err != nil {
		return err
	}

	*o = HttpSyntheticMonitorUpdate(varHttpSyntheticMonitorUpdate)
