...
type _CreateLevelPolicyBindingsRequestDto CreateLevelPolicyBindingsRequestDto
...
func (o *CreateLevelPolicyBindingsRequestDto) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCreateLevelPolicyBindingsRequestDto := _CreateLevelPolicyBindingsRequestDto{}

	err = json.Unmarshal(bytes, &varCreateLevelPolicyBindingsRequestDto)

	if err != nil {
		return err
	}

	*o = CreateLevelPolicyBindingsRequestDto(varCreateLevelPolicyBindingsRequestDto)
