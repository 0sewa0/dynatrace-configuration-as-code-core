...
type _SubscriptionCostBookingDto SubscriptionCostBookingDto
...
func (o *SubscriptionCostBookingDto) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSubscriptionCostBookingDto := _SubscriptionCostBookingDto{}

	err = json.Unmarshal(bytes, &varSubscriptionCostBookingDto)

	if err != nil {
		return err
	}

	*o = SubscriptionCostBookingDto(varSubscriptionCostBookingDto)
